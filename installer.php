...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'AlinaGrecu_tp_wine_23c5a8035f8991c46705_20220818142147_archive.zip';
	const ARCHIVE_SIZE		 = '72931385';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '23c5a80-18142147';
    const SECONDARY_PACKAGE_HASH = '104b371-18142147';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v1.4.7.2==');
		self::log('----------------------------------------------------');
